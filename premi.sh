...
TIMES="10"
CHATID="6752163466"
KEY="6960987223:AAHQ6yIkKz-XBEyl2uYFpoE0PZBe24p5W00"
...
clear;clear;clear
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "  Welcome To BOGEL TUNNELING ${YELLOW}(${NC}${green} Stable Edition ${NC}${YELLOW})${NC}"
echo -e " This Will Quick Setup VPN Server On Your Server"
echo -e "  Author : ${green}BOGEL STORE® ${NC}${YELLOW}(${NC} ${green} BOGEL TUNNELING PROJECT ${NC}${YELLOW})${NC}"
echo -e " © Recode At®${YELLOW}(${NC} 2024 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
###### IZIN SC 
...
# USERNAME
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/wggly/iz/main/ip | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/wggly/iz/main/ip | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
# DETAIL ORDER
...
Exp1=$(curl https://raw.githubusercontent.com/wggly/iz/main/ip | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/wggly/noobz/main/"
...
restart_system() {
url_izin="https://raw.githubusercontent.com/wggly/iz/main/ip"
